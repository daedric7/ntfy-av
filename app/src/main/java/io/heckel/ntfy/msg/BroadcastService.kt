...
class BroadcastService(private val ctx: Context) {
    ...
    companion object {
        ...
        private const val MESSAGE_RECEIVED_ACTION = "pt.aguiarvieira.ntfy.MESSAGE_RECEIVED"
        private const val MESSAGE_SEND_ACTION = "pt.aguiarvieira.ntfy.SEND_MESSAGE"
        private const val USER_ACTION_ACTION = "pt.aguiarvieira.ntfy.USER_ACTION"
    }
}
